  ...
  return (
    ...
    >
      ...
      <div className="absolute top-5 left-5 right-5 flex items-start justify-between">
        ...
        <div className="w-8 h-8 border border-[#ebe4d4]/30 grid place-items-center opacity-0 group-hover:opacity-100 group-hover:border-[#c8a86a] transition duration-500">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
        <motion.div
          ...
          className="text-[10px] tracking-[0.3em] text-[#c8a86a] uppercase font-light mb-2"
        >
          {card.label}
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="mt-3 font-[Cormorant_Garamond] italic text-[#ebe4d4]/60 text-sm md:text-base"
        >
          {card.tagline}
        </motion.div>
        <div className="mt-5 flex items-center gap-3 text-[10px] tracking-[0.3em] text-[#ebe4d4]/30 group-hover:text-[#ebe4d4] transition font-light">
          ENTER
